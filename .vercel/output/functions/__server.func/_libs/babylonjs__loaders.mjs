import { T as Tools, R as RegisterSceneLoaderPlugin, O as Observable, L as Logger, D as DataReader, A as AssetContainer, a as DecodeBase64UrlToBinary, b as RuntimeError, E as ErrorCodes, M as Matrix, V as Vector4, c as Vector3, d as Vector2, e as Texture, f as Effect, S as ShaderMaterial, C as Color4, g as AbstractMesh, h as Skeleton, G as GetBlobBufferSource, i as StandardMaterial, j as Color3, k as Material, l as Constants, m as Animation, Q as Quaternion, H as HemisphericLight, n as DirectionalLight, P as PointLight, o as SpotLight, F as FreeCamera, p as Camera, q as Mesh, B as Bone, r as VertexData, s as MultiMaterial, t as Geometry, u as SubMesh, v as VertexBuffer, w as TransformNode, x as deepMerge, y as MorphTargetManager, z as MorphTarget, I as Lazy, J as Buffer, K as Deferred, N as GetMimeType, U as IsBase64DataUrl, W as LoadFileError, X as GetTypedArrayConstructor, Y as TmpVectors, Z as BoundingInfo, _ as RawCubeTexture, $ as SphericalHarmonics, a0 as SphericalPolynomial, a1 as MeshoptCompression, a2 as Light, a3 as DracoDecoder, a4 as RectAreaLight, a5 as PBRMaterial, a6 as RenderTargetTexture, a7 as Sound, a8 as WeightedSound, a9 as AnimationEvent, aa as getAnimationTypeByFlowGraphType, ab as RandomGUID, ac as FlowGraphCoordinator, ad as ParseFlowGraphAsync, ae as addToBlockFactory, af as FlowGraphBlock, ag as RichTypeAny } from "./babylonjs__core.mjs";
...
const LazyAnimationGroupModulePromise = new Lazy(() => import("./babylonjs__core.mjs").then(function(n) {
  return n.ar;
}));
const LazyLoaderAnimationModulePromise = new Lazy(() => Promise.resolve().then(function() {
  return glTFLoaderAnimation;
}));
class ArrayItem {
  /**
      ...
      if (!this.parent.skipMaterials && this._pbrMaterialImpl == null) {
        if (this.parent.useOpenPBR || this.isExtensionUsed("KHR_materials_openpbr")) {
          this._pbrMaterialImpl = {
            materialClass: (await import("./babylonjs__core.mjs").then(function(n) {
              return n.as;
            })).OpenPBRMaterial,
            adapterClass: (await Promise.resolve().then(function() {
              return openpbrMaterialLoadingAdapter;
          ...
          this._pbrMaterialImpl = {
            ...
            adapterClass: (await Promise.resolve().then(function() {
              return pbrMaterialLoadingAdapter;
...
const glTFLoaderAnimation = /* @__PURE__ */ Object.freeze({
  __proto__: null,
...
const openpbrMaterialLoadingAdapter = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  OpenPBRMaterialLoadingAdapter
});
...
const pbrMaterialLoadingAdapter = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  PBRMaterialLoadingAdapter
});
const NAME$E = "EXT_lights_image_based";
...
registerGLTFExtension(NAME$E, true, (loader) => new EXT_lights_image_based(loader));
const NAME$D = "EXT_mesh_gpu_instancing";
...
registerGLTFExtension(NAME$D, true, (loader) => new EXT_mesh_gpu_instancing(loader));
const NAME$C = "EXT_meshopt_compression";
...
registerGLTFExtension(NAME$C, true, (loader) => new EXT_meshopt_compression(loader));
const NAME$B = "EXT_texture_webp";
...
registerGLTFExtension(NAME$B, true, (loader) => new EXT_texture_webp(loader));
const NAME$A = "EXT_texture_avif";
...
registerGLTFExtension(NAME$A, true, (loader) => new EXT_texture_avif(loader));
const NAME$z = "EXT_lights_ies";
class EXT_lights_ies {
  ...
  constructor(loader) {
    this.name = NAME$z;
    this._loader = loader;
    this.enabled = this._loader.isExtensionUsed(NAME$z);
  }
  /** @internal */
  dispose() {
    this._loader = null;
...
registerGLTFExtension(NAME$z, true, (loader) => new EXT_lights_ies(loader));
const NAME$y = "KHR_draco_mesh_compression";
class KHR_draco_mesh_compression {
  ...
  constructor(loader) {
    ...
    this._loader = loader;
    this.enabled = DracoDecoder.DefaultAvailable && this._loader.isExtensionUsed(NAME$y);
  }
  /** @internal */
  dispose() {
...
registerGLTFExtension(NAME$y, true, (loader) => new KHR_draco_mesh_compression(loader));
...
const flowGraphGLTFDataProvider = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  FlowGraphGLTFDataProvider
});
