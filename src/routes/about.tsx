  ...
  return (
    <main className="page-wrap px-4 py-12 md:py-24 max-w-7xl mx-auto space-y-32">
      ...
      <section className="text-center space-y-6">
        ...
        <h1 className="display-title text-5xl md:text-7xl font-bold text-[var(--fg)] tracking-tight leading-tight">
      ...
      <section className="space-y-12">
        ...
        {/* Abstract UI Diagram */}
        <div className="relative max-w-5xl mx-auto bg-[var(--bg-base)] border border-[var(--line)] rounded-2xl p-2 shadow-2xl overflow-hidden hidden md:block">
          {/* Mock Header */}
          ...
          {/* Mock Workspace Grid */}
          <div className="h-[400px] grid grid-cols-12 gap-2 p-2">
            
            {/* Sidebar Diagram */}
            <div className="col-span-3 bg-[var(--surface-strong)] rounded-lg border border-[var(--line)] p-4 flex flex-col gap-4 group hover:border-[var(--lagoon)] transition-colors relative overflow-hidden">
              <div className="flex items-center gap-2 text-[var(--fg)] font-bold mb-2"><FolderOpen className="w-4 h-4 text-[var(--lagoon)]" /> Asset Library</div>
            ...
            <div className="col-span-3 bg-[#2a2c2e] rounded-lg border border-[var(--line)] relative group hover:border-[var(--brand)] transition-colors overflow-hidden">
               ...
               <div className="absolute inset-0 flex items-center justify-center">
                 <div className="w-32 h-32 border-4 border-orange-500/50 bg-orange-500/10 flex items-center justify-center">
                    <div className="w-8 h-8 bg-[var(--brand)] rounded-sm" />
                 </div>
               </div>
               <div className="absolute top-4 left-4 flex items-center gap-2 text-white font-bold"><Layers className="w-4 h-4 text-[var(--brand)]" /> 2D Blueprint</div>
               <div className="absolute inset-0 bg-[var(--brand)]/5 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
            </div>

            {/* Properties Diagram */}
            <div className="col-span-3 bg-[var(--surface-strong)] rounded-lg border border-[var(--line)] p-4 flex flex-col gap-4 group hover:border-[var(--cta)] transition-colors relative overflow-hidden">
              <div className="flex items-center gap-2 text-[var(--fg)] font-bold mb-2"><Palette className="w-4 h-4 text-[var(--cta)]" /> Properties</div>
            ...
            {/* 3D View Diagram */}
            <div className="col-span-3 bg-gradient-to-b from-[#87CEEB] to-[#E0E7FF] rounded-lg border border-[var(--line)] relative group hover:border-[var(--brand-dark)] transition-colors overflow-hidden shadow-inner flex flex-col justify-end p-8">
              <div className="absolute top-4 left-4 flex items-center gap-2 text-[var(--fg)] font-bold"><Box className="w-4 h-4 text-[var(--brand-dark)]" /> Live 3D View</div>
              
              {/* Fake 3D Box via CSS */}
              <div className="w-full h-24 bg-orange-200 border-t-8 border-orange-300 transform perspective-1000 rotateX-45 shadow-2xl relative">
                 <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-8 h-8 bg-gray-700 rounded-sm shadow-xl" />
              </div>
            </div>
      ...
      <section className="space-y-16">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <h3 className="text-3xl font-bold text-[var(--fg)]">Comprehensive Asset Library</h3>
          ...
          <div className="flex-1 island-shell p-6 rounded-3xl border border-[var(--line)]">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <h3 className="text-3xl font-bold text-[var(--fg)]">Precision 2D Blueprint Editor</h3>
            <p className="text-[var(--fg-soft)] text-lg leading-relaxed">
          ...
          <div className="flex-1 w-full bg-[#2a2c2e] rounded-3xl h-64 border border-[var(--line)] shadow-inner relative overflow-hidden flex items-center justify-center">
              ...
              <div className="w-48 h-48 border-l-4 border-b-4 border-r-4 border-orange-500/80 bg-orange-500/10 flex items-center justify-center relative">
                 <div className="absolute top-0 left-0 w-full h-1 border-t-4 border-dashed border-orange-500/30" />
                 <div className="w-12 h-12 bg-white/10 border border-white/30 rotate-45 rounded-sm" />
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <h3 className="text-3xl font-bold text-[var(--fg)]">Contextual Properties & Materials</h3>
            <p className="text-[var(--fg-soft)] text-lg leading-relaxed">
          ...
          <div className="flex-1 island-shell p-8 rounded-3xl border border-[var(--line)]">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <h3 className="text-3xl font-bold text-[var(--fg)]">Immersive Live 3D View</h3>
            <p className="text-[var(--fg-soft)] text-lg leading-relaxed">
          ...
          <div className="flex-1 island-shell p-2 rounded-3xl border border-[var(--line)]">
