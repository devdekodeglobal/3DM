...
import {
  HERO_AFTERGLOW_BOOTH_CONFIG,
  HERO_AFTERGLOW_ELEMENTS,
} from "../components/heroAfterglowData";
    ...
    <main className="page-wrap px-4 py-12 md:py-24 max-w-7xl mx-auto space-y-32">
      ...
      <section className="text-center space-y-6">
        ...
        <h1 className="display-title text-4xl md:text-6xl lg:text-7xl font-bold text-[var(--fg)] tracking-tight leading-tight">
          Design in 2D. <br />{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--lagoon)] to-[var(--brand)]">
            Experience in 3D.
          </span>
        </h1>
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-[var(--fg-soft)] leading-relaxed">
          krafc is a professional, browser-based spatial design platform. Plan
          your rooms and exhibition spaces in a lightning-fast 2D blueprint
          editor, and watch them instantly materialize into immersive, real-time
          3D environments.
        </p>
        <div className="pt-8 flex justify-center gap-4">
          <Link
            ...
            style={{ padding: "15px 36px", fontSize: "1.1rem" }}
          >
        ...
        <ScrollReveal animation="fade-up">
          <div className="text-center">
            ...
            <p className="text-[var(--fg-soft)] mt-4 max-w-2xl mx-auto">
              Everything you need, perfectly organized. Our split-panel
              interface allows you to design, edit, and visualize simultaneously
            ...
            <div className="w-full">
              ...
              <div className="h-6 md:h-10 border-b border-[var(--line)] bg-[var(--surface)] flex items-center justify-between px-2 md:px-4 rounded-t-xl overflow-hidden">
                <div className="flex gap-1 md:gap-2 shrink-0">
                  <div className="w-1.5 h-1.5 md:w-3 md:h-3 rounded-full bg-red-400"></div>
                  <div className="w-1.5 h-1.5 md:w-3 md:h-3 rounded-full bg-amber-400"></div>
                  <div className="w-1.5 h-1.5 md:w-3 md:h-3 rounded-full bg-green-400"></div>
                </div>
              ...
              <div className="grid grid-cols-12 gap-1 md:gap-2 p-1 md:p-2 h-[200px] md:h-[400px]">
                ...
                <div className="col-span-3 bg-[var(--surface-strong)] rounded-lg border border-[var(--line)] p-1 md:p-4 flex flex-col gap-1 md:gap-4 group hover:border-[var(--lagoon)] transition-colors relative overflow-hidden">
                  <div className="flex items-center gap-1 md:gap-2 text-[var(--fg)] font-bold mb-1 md:mb-2 text-[6px] md:text-base leading-tight">
                    <FolderOpen className="w-2 h-2 md:w-4 md:h-4 text-[var(--lagoon)]" />{" "}
                    Asset Lib
                  </div>
                  <div className="h-8 bg-[var(--bg-base)] rounded-md w-full border border-[var(--line)] px-2 flex items-center text-[5px] md:text-[9px] text-[var(--fg-dim)]">
                    Search lounge assets
                  </div>
                  <div className="flex-1 space-y-1.5 md:space-y-2">
                    {[
                      ...
                      <div
                        key={asset.label}
                        className={`h-10 md:h-14 rounded-md w-full border px-1.5 md:px-2 flex items-center gap-1.5 md:gap-2 ${index === 2 ? "bg-[var(--brand)]/10 border-[var(--brand)]" : "bg-[var(--bg-base)] border-[var(--line)]"}`}
                      >
                        ...
                        <span className="text-[5px] md:text-[9px] font-bold text-[var(--fg)] truncate">
                          {asset.label}
                        </span>
                      </div>
                    ))}
                ...
                <div className="col-span-3 bg-[var(--surface-strong)] rounded-lg border border-[var(--line)] relative group hover:border-[var(--brand)] transition-colors overflow-hidden flex flex-col p-1 md:p-3">
                  <div className="flex items-center gap-1 md:gap-2 text-[var(--fg)] font-bold mb-1 md:mb-2 text-[6px] md:text-base leading-tight">
                    <Layers className="w-2 h-2 md:w-4 md:h-4 text-[var(--brand)]" />{" "}
                    2D Blueprint
                  </div>
                ...
                <div className="col-span-3 bg-[var(--surface-strong)] rounded-lg border border-[var(--line)] p-1 md:p-4 flex flex-col gap-1 md:gap-4 group hover:border-[var(--cta)] transition-colors relative overflow-hidden">
                  <div className="flex items-center gap-1 md:gap-2 text-[var(--fg)] font-bold mb-1 md:mb-2 text-[6px] md:text-base leading-tight">
                    <Palette className="w-2 h-2 md:w-4 md:h-4 text-[var(--cta)]" />{" "}
                    Props
                  </div>
                  <div className="w-2/3 h-4 bg-[var(--bg-base)] rounded-sm px-1 flex items-center text-[5px] md:text-[8px] font-bold text-[var(--fg-dim)]">
                    SPACE
                  </div>
                  <div className="grid grid-cols-2 gap-1 md:gap-2">
                    {[
                      ...
                      <div
                        key={material.label}
                        className={`h-12 md:h-16 rounded-md border p-1 md:p-2 flex flex-col justify-between ${index === 3 ? "bg-[var(--brand)]/10 border-[var(--brand)]" : "bg-[var(--bg-base)] border-[var(--line)]"}`}
                      >
                        <div
                          className="w-full h-5 md:h-7 rounded-sm shadow-inner border border-black/10"
                          style={{ backgroundColor: material.color }}
                        />
                        <span className="text-[4px] md:text-[8px] font-bold text-[var(--fg)] truncate">
                          {material.label}
                        </span>
                      </div>
                    ))}
                ...
                {/* 3D View Render */}
                <div className="col-span-3 bg-[var(--surface-strong)] rounded-lg border border-[var(--line)] relative group hover:border-[var(--brand-dark)] transition-colors overflow-hidden shadow-inner flex flex-col">
                  <div className="absolute top-1 left-1 md:top-3 md:left-3 z-10 flex items-center gap-1 md:gap-2 text-[var(--fg)] font-bold text-[6px] md:text-base leading-tight">
                    <Box className="w-2 h-2 md:w-4 md:h-4 text-[var(--brand-dark)]" />{" "}
                    3D View
                  </div>
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <p className="text-[var(--fg-soft)] text-lg leading-relaxed">
                Browse through our extensive, categorized library of
                professional 3D models. From standard structures and exhibition
                walls to detailed furniture like sofas, tables, and ambient
                decor. Simply drag and drop an item into the scene.
              </p>
            </div>
                ...
                <li className="flex items-center gap-4 p-3 bg-[var(--bg-base)] rounded-lg hover:bg-[var(--surface)] transition-colors cursor-default border border-transparent hover:border-[var(--line)]">
                  <div className="w-9 h-9 bg-[var(--brand)]/5 rounded-md flex items-center justify-center p-1">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M-6 -6 Q0 -12 6 -6 Q12 0 6 6 Q0 12 -6 6 Q-12 0 -6 -6"
        ...
        <ScrollReveal animation="slide-right">
          <div className="flex flex-col md:flex-row-reverse items-stretch md:items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-[var(--fg)]">
                Precision 2D Blueprint Editor
              </h3>
              <p className="text-[var(--fg-soft)] text-lg leading-relaxed">
                Design with architectural accuracy. The blueprint canvas acts as
                your floor plan, complete with a measurable snap-grid. Move
                objects, adjust rotations, define room dimensions, and toggle
                individual structural walls with mathematical precision.
              </p>
            </div>
            <div className="w-full md:flex-1 bg-[#2a2c2e] rounded-3xl h-64 border border-[var(--line)] shadow-inner relative overflow-hidden flex items-center justify-center shrink-0">
              <div
                ...
                style={{
                  backgroundImage:
                    "radial-gradient(circle at 4px 4px, white 1px, transparent 0)",
              ...
              <div className="w-32 h-32 sm:w-48 sm:h-48 border-l-4 border-b-4 border-r-4 border-orange-500/80 bg-orange-500/10 flex items-center justify-center relative">
                ...
                <div className="absolute -bottom-8 text-xs text-orange-400 font-mono tracking-widest">
                  5M X 5M SPACE
                </div>
              </div>
            </div>
        ...
        <ScrollReveal animation="slide-left">
          <div className="flex flex-col md:flex-row items-stretch md:items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-[var(--fg)]">
                Contextual Properties & Materials
              </h3>
              <p className="text-[var(--fg-soft)] text-lg leading-relaxed">
                Select any object or the floor itself to access the dynamic
                properties panel. Instantly swap out floor surfaces like
                Hardwood, Polished Marble, or Carpet. Adjust object scales,
                tweak custom color codes, and toggle structural ceilings on the
                fly.
              </p>
            </div>
            <div className="w-full md:flex-1 island-shell p-8 rounded-3xl border border-[var(--line)]">
              <h4 className="text-xs font-bold text-[var(--fg-dim)] tracking-widest uppercase mb-4">
                Floor Surface
              </h4>
              <div className="space-y-3">
                <div className="flex items-center justify-between p-4 bg-[var(--bg-base)] rounded-xl border border-[var(--line)]">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-[var(--fg)]">Hardwood</span>
                  </div>
                </div>
                <div className="flex items-center justify-between p-4 bg-[var(--brand)]/10 rounded-xl border border-[var(--brand)]">
                  <div className="flex items-center gap-3">
                    <div className="w-6 h-6 bg-slate-100 rounded-sm border border-slate-300" />
                ...
                <div className="flex items-center justify-between p-4 bg-[var(--bg-base)] rounded-xl border border-[var(--line)]">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-[var(--fg)]">Carpet</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <ScrollReveal animation="slide-right">
          <div className="flex flex-col md:flex-row-reverse items-stretch md:items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-[var(--fg)]">
                Immersive Live 3D View
              </h3>
              <p className="text-[var(--fg-soft)] text-lg leading-relaxed">
                Every change you make in the blueprint instantly updates in the
                beautiful, hardware-accelerated 3D viewport. Orbit around your
                creation, switch to Flight Mode for a first-person walkthrough,
                and capture high-resolution snapshot renders with a single
                click.
              </p>
            </div>
            <div className="w-full md:flex-1 island-shell p-2 rounded-3xl border border-[var(--line)] shrink-0">
              <div className="w-full h-64 bg-gradient-to-br from-slate-200 to-slate-400 rounded-2xl relative shadow-inner flex items-center justify-center overflow-hidden">
                <div className="absolute top-4 left-4 flex gap-2 flex-wrap max-w-[80%]">
                  <div className="px-3 py-1 bg-black/60 backdrop-blur-md rounded-full text-[10px] text-white font-bold tracking-widest">
                    ORBIT MODE
                  </div>
                  <div className="px-3 py-1 bg-black/60 backdrop-blur-md rounded-full text-[10px] text-white font-bold tracking-widest">
                    HQ: ON
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <ScrollReveal animation="fade-up" delay={100}>
            <div className="p-6 bg-[var(--surface-strong)] border border-[var(--line)] rounded-2xl h-full">
              ...
              <p className="text-sm text-[var(--fg-soft)]">
                Log in to securely save and sync your projects instantly to our
                cloud database.
              </p>
            </div>
          </ScrollReveal>
          <ScrollReveal animation="fade-up" delay={200}>
            <div className="p-6 bg-[var(--surface-strong)] border border-[var(--line)] rounded-2xl h-full">
              ...
              <p className="text-sm text-[var(--fg-soft)]">
                Switch devices? No problem. Pull up your saved spaces and
                continue designing.
              </p>
            </div>
          </ScrollReveal>
          <ScrollReveal animation="fade-up" delay={300}>
            <div className="p-6 bg-[var(--surface-strong)] border border-[var(--line)] rounded-2xl h-full">
              ...
              <p className="text-sm text-[var(--fg-soft)]">
                Generate formatted technical reports containing dimensions, item
                lists, and 3D screenshots.
              </p>
            </div>
          </ScrollReveal>
        </div>
