...
export const ASSET_DIMENSIONS: Record<string, { w: number; h: number }> = {
  ...
  'chair_1': { w: 0.9917, h: 1.0000 },
  'chair_2': { w: 0.9911, h: 1.0000 },
  'coffee_table': { w: 1.0000, h: 0.7457 },
  'dustbin': { w: 0.8155, h: 1.0000 },
  'game_ready_free_livingroom_tv': { w: 1.0000, h: 0.1069 },
  'modern_dining_chair': { w: 1.0000, h: 0.8109 },
  'plant': { w: 1.0000, h: 0.8134 },
  'rectangular_side_coffee_table': { w: 1.0000, h: 0.3848 },
  'round_table_1': { w: 1.0000, h: 1.0000 },
  'sink_1': { w: 1.0000, h: 0.4943 },
  'table': { w: 0.3752, h: 1.0000 },
  'table1': { w: 1.0000, h: 0.5457 },
  'table2': { w: 1.0000, h: 0.9213 },
  'tv_lcd': { w: 0.0591, h: 1.0000 },
  'wall_light_1': { w: 1.0000, h: 0.5519 },
  'wall_light_2': { w: 0.8148, h: 1.0000 },
  'wall_light_3': { w: 0.6828, h: 1.0000 },
}
